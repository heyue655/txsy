...
> 此目录由 `project-knowledge` 技能维护。所有权威设计文档均存放于此。

## 文档目录

| 文档 | 说明 | 最后更新 |
|------|------|----------|
| [architecture.md](./architecture.md) | 系统架构总览 | 2026-06-05 |
| [api.md](./api.md) | API 接口规范 | 2026-06-05 |
...
- **认证/JWT/SSO** → [features/auth.md](./features/auth.md)
- **LLM/AI对话/SSE流式** → [features/soul-dialog.md](./features/soul-dialog.md)
- **书籍/书单/分类** → [features/books.md](./features/books.md)
